  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 space-y-6">
            ...
            <div className="p-4 bg-muted rounded-lg">
              <p className="text-sm text-muted-foreground">
                ...
                <button
                  ...
                  onClick={() => toast.info("Data is aggregated to improve transport planning.")}
                >
                  Learn more
                </button>
              </p>
        ...
        {/* Save Button */}
        <Button
          className="w-full py-3 rounded-full bg-accent hover:bg-accent/90 text-accent-foreground"
          onClick={() => {
            localStorage.setItem("autoTracking", String(autoTracking));
            localStorage.setItem("anonymizeData", String(anonymizeData));
            localStorage.setItem("dataConsent", String(dataConsent));
